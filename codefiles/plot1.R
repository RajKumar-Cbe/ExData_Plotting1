...
hist(ddayspower$Global_active_power, col = "red", main = "Global Active Power",   xlab = "Global Active Power (Killowatts)")
## Write the first plot to a file called Plot1.Png
